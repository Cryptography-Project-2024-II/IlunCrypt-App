package com.iluncrypt.iluncryptapp.controllers.digitalsignature;
...
public class DigitalSignatureController {
    ...
    public DigitalSignatureController() {
        ...
        delayTransition.setOnFinished(event -> {
            if (!isMouseOverDescription) {
                loadView("views/digital-signature/digital-signature-methods-description-view.fxml");
            }
        });
    }
    ...
    @FXML
    private void showDigitalSignatureDescription() { loadView("views/digital-signature/digital-signature-methods-description-view.fxml"); }
