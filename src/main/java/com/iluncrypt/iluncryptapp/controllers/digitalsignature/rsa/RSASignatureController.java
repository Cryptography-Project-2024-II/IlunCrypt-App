...
public class RSASignatureController implements CipherController, Initializable {
    ...
    public void showInfoDialog(ActionEvent actionEvent) {
        infoDialog.showInfoDialog(
                ...
                "RSA Digital Signatures use the RSA algorithm to verify the authenticity and integrity of a file. " +
    ...
    public void signData(ActionEvent actionEvent) {
        try {
            ...
            String signature = RSAManager.signFile(selectedFile, privateKey);
    ...
    public void verifySignature(ActionEvent actionEvent) {
        try {
            ...
            boolean isValid = RSAManager.verifyFileSignature(
                    selectedFile,
