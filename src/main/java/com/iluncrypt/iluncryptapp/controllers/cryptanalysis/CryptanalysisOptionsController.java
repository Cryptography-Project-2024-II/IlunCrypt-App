package com.iluncrypt.iluncryptapp.controllers.cryptanalysis;
...
public class CryptanalysisOptionsController {
    ...
    public CryptanalysisOptionsController() {
        ...
        delayTransition.setOnFinished(event -> {
            if (!isMouseOverDescription) {
                loadView("views/cryptanalysis/cryptanalysis-methods-description-view.fxml");
            }
        });
    }
    ...
    @FXML
    private void handleHoverFriedman(MouseEvent event) { updateHoverView("views/cryptanalysis/friedman/friedman-analysis-description-view.fxml"); }

    @FXML
    private void handleHoverBrauer(MouseEvent event) { updateHoverView("views/cryptanalysis/brauer/brauer-analysis-description-view.fxml"); }

    @FXML
    private void handleHoverBruteForce(MouseEvent event) { updateHoverView("views/cryptanalysis/brute-force/brute-force-analysis-description-view.fxml"); }

    @FXML
    private void handleHoverFrequency(MouseEvent event) { updateHoverView("views/cryptanalysis/frequency/frequency-analysis-description-view.fxml"); }
    ...
    @FXML
    private void showCryptanalysisMethodsDescription() { loadView("views/cryptanalysis/cryptanalysis-methods-description-view.fxml"); }
