...
/**
 * Controller for the Substitution Cipher description view.
 *
 * This controller manages both the user-friendly general explanation and the detailed technical
 * description for the Substitution Cipher. It utilizes the {@code LatexImageGenerator} utility class to
 ...
 */
public class SubstitutionCipherDescriptionController {
    ...
    /**
     * Initializes the Substitution Cipher description view.
    ...
    public void initialize() {
        ...
        encryptionFormula.setImage(LatexImageGenerator.createLatexImage("E(x) = P(x)"));
        decryptionFormula.setImage(LatexImageGenerator.createLatexImage("D(x) = P^{-1}(x)"));
        exampleImage.setImage(LatexImageGenerator.createLatexImage("HELLO \\rightarrow QXZRR"));
