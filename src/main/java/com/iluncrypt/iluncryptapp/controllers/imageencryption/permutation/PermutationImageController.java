...
/**
 * Controller for Permutation image encryption.
 */
public class PermutationImageController implements CipherController, Initializable {
    ...
    public PermutationImageController(Stage stage) {
        this.stage = stage;
    ...
    private void encryptImage() {
        // Implement Permutation image encryption logic
    }

    @FXML
    private void decryptImage() {
        // Implement Permutation image decryption logic
    }
