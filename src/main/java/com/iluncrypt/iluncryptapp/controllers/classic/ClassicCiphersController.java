package com.iluncrypt.iluncryptapp.controllers.classic;
...
public class ClassicCiphersController {
    ...
    public ClassicCiphersController() {
        ...
        delayTransition.setOnFinished(event -> {
            if (!isMouseOverDescription) {
                loadView("views/classic/classic-methods-description-view.fxml");
            }
        });
    }
    ...
    private void handleHoverAffine(MouseEvent event) {
        updateHoverView("views/classic/affine/affine-cipher-description-view.fxml");
    }
    ...
    private void handleHoverMultiplicative(MouseEvent event) {
        updateHoverView("views/classic/multiplicative/multiplicative-cipher-description-view.fxml");
    }
    ...
    private void handleHoverShift(MouseEvent event) {
        updateHoverView("views/classic/shift/shift-cipher-description-view.fxml");
    }
    ...
    private void handleHoverHill(MouseEvent event) {
        updateHoverView("views/classic/hill/hill-cipher-description-view.fxml");
    }
    ...
    private void handleHoverPermutation(MouseEvent event) {
        updateHoverView("views/classic/permutation/permutation-cipher-description-view.fxml");
    }
    ...
    private void handleHoverSubstitution(MouseEvent event) {
        updateHoverView("views/classic/substitution/substitution-cipher-description-view.fxml");
    }
    ...
    private void handleHoverVigenere(MouseEvent event) {
        updateHoverView("views/classic/vigenere/vigenere-cipher-description-view.fxml");
    }
