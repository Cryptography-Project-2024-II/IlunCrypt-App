...
/**
 * Controller for the Vigenère Cipher description view.
 *
 * This controller manages both the user-friendly general explanation and the detailed technical
 * description for the Vigenère Cipher. It utilizes the {@code LatexImageGenerator} utility class to
 ...
 */
public class VigenereCipherDescriptionController {
    ...
    /**
     * Initializes the Vigenère Cipher description view.
    ...
    public void initialize() {
        ...
        encryptionFormula.setImage(LatexImageGenerator.createLatexImage("E(i) = (P(i) + K(i)) \\mod 26"));
        decryptionFormula.setImage(LatexImageGenerator.createLatexImage("D(i) = (C(i) - K(i)) \\mod 26"));
        exampleImage.setImage(LatexImageGenerator.createLatexImage("HELLO \\rightarrow E(7) = (7 + 10) \\mod 26 = 17 \\rightarrow R"));
