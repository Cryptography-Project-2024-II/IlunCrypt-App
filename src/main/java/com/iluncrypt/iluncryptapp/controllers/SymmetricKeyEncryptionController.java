...
public class SymmetricKeyEncryptionController {
    ...
    public SymmetricKeyEncryptionController() {
        ...
        delayTransition.setOnFinished(event -> {
            if (!isMouseOverDescription) {
                loadView("views/symmetric-methods-description-view.fxml");
            }
        });
    }
    ...
    @FXML
    private void handleHoverAES(MouseEvent event) { updateHoverView("views/AES-description-view.fxml"); }

    @FXML
    private void handleHoverDES(MouseEvent event) { updateHoverView("views/DES-description-view.fxml"); }

    @FXML
    private void handleHoverTDES(MouseEvent event) { updateHoverView("views/TDES-description-view.fxml"); }

    @FXML
    private void handleHoverSDES(MouseEvent event) { updateHoverView("views/SDES-description-view.fxml"); }
    ...
    @FXML
    private void showSymmetricMethodsDescription() { loadView("views/symmetric-methods-description-view.fxml"); }
